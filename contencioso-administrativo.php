                ...
                <ul>
                    ...
                    <li class="elemento_seleccionado"><a href="especialidad.php">Especialidad</a>
                        <ul class='submenu'>
                            ...
                            <li class="elemento_seleccionado"><a href="contencioso-administrativo.php">Derecho contecioso-administrativo</a></li>
    ...
    <div id="contenido">
        <article class="articulo">
            <div class="estilo-contenido">
                ...
                <p><a href="" >Responsabilidad patrimonial de la Administración</a></p>
                <p><a href="" >Protección de derechos fundamentales</a></p>
