            ...
            <nav id="nav-sec">
                <ul>
                    ...
                    <li class="elemento_seleccionado"><a href="especialidad.php">Especialidad</a>
                        <ul class='submenu'>
                            <li class="elemento_seleccionado"><a href="mercantil.php">Derecho mercantil</a></li>
...
<div id="contenido">
    <article class="articulo">
        <div class="estilo-contenido">
            ...
            <p><a href="" >Infracciones de propiedad industrial e intelectual, y acciones de competencia desleal</a></p>
            <p><a href="" >Procesos de reclamación de cantidad</a></p>
            <p><a href="" >Presentación y aprobación de cuentas de administradores</a></p>
            <p><a href="" >Nulidad de clausulas generales de contratación</a></p>
