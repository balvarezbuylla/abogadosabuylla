...
<div id="pagina_centrada">
    <div class="menu">
        <div id="nav-ppal">
            <nav id="nav-sec">
                <ul>
                    <li class="elemento_seleccionado"><a href="index.php" title="Home">Home</a></li>
		...
		<div id="contenido">
			<article class="articulo">
				<div class="estilo-contenido">		
					<!-- Contenido principal -->
					<p><img class="derecha" title="home_main" src="images/home.jpg" alt="Foto sentado escritorio" width="260px" height="260px" /><strong>Despacho de Procuradores de los Tribunales especialistas en procedimientos judiciales mercantiles, civiles y contencioso-administrativos.</strong><br/>
					...
					<div id="subcontenido">
					<p>Nuestro horario de oficina es desde las 9:00 hrs hasta las 20:00 hrs. <br>Fuera de este horario, puede contactar con nosotros en el tel&eacute;fono <br>+34 91 578 06 10.</p>
					</div>
					
				</div><!-- estilo-contenido -->
			</article>
			<div class="huissiers">
						<a href=" http://www.uihj.com/en/" target="_blank"><br />
							<img src="images/uihj.jpg" alt="International Union of Judicial Officers" title="International Union of Judicial Officers"/><br />
						</a><br />
					</div>
		</div><!-- contenido -->
</div>
